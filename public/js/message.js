    ...
    success: function (data) {
      ...
      data.forEach(message => {
        ...
        if (message.IDUTILISATEUR !== authUtilisateur) {
          console.log('gauche');
          $('.messages').append(`
          <div class="col-start-1 col-end-8 p-3 rounded-lg"> <!-- Message à gauche -->
          ...
          console.log("droite");
          $('.messages').append(`
          <div class="col-start-10 col-end-13 p-3 rounded-lg justify-self-end"> <!-- Message à droite aligné tout à fait à droite -->
